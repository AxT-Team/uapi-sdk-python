...
class GetMiscWeather200Response(BaseModel):
    ...
    alerts: Optional[List[GetMiscWeather200ResponseAlertsInner]] = Field(default=None, description="官方气象预警列表（存在有效预警时返回）")
    ...
    __properties: ClassVar[List[str]] = ["adcode", "air_pollutants", "alerts", "aqi", "aqi_category", "aqi_level", "aqi_primary", "city", "cloud", "district", "feels_like", "forecast", "hourly_forecast", "humidity", "life_indices", "minutely_precip", "precipitation", "pressure", "province", "report_time", "temp_max", "temp_min", "temperature", "uv", "visibility", "weather", "weather_icon", "wind_direction", "wind_power"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alerts": [GetMiscWeather200ResponseAlertsInner.from_dict(_item) for _item in obj["alerts"]] if obj.get("alerts") is not None else None,
            "aqi": obj.get("aqi"),
