...
class GetWebTomarkdownAsyncStatus200ResponseAnyOf3(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["completed_at", "created_at", "duration", "error", "progress", "started_at", "status", "task_id", "url"]
