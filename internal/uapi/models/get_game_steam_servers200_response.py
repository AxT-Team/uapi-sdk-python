...
class GetGameSteamServers200Response(BaseModel):
    """
    GetGameSteamServers200Response
    """ # noqa: E501
    appid: Optional[StrictInt] = None
    count: Optional[StrictInt] = None
    query: Optional[StrictStr] = None
    servers: Optional[List[GetGameSteamServers200ResponseServersInner]] = None
    __properties: ClassVar[List[str]] = ["appid", "count", "query", "servers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "query": obj.get("query"),
            "servers": [GetGameSteamServers200ResponseServersInner.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None
        })
        return _obj
