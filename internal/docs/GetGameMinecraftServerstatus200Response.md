...
**online_players** | [**List[GetGameMinecraftServerstatus200ResponseOnlinePlayersInner]**](GetGameMinecraftServerstatus200ResponseOnlinePlayersInner.md) | 当前在线玩家列表。如果服务器没有返回这个字段，它会省略。部分服务器返回的列表可能不完整。 | [optional] 
