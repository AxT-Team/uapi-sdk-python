...
class GetHistoryProgrammerToday200ResponseEventsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["category", "description", "importance", "relevance_score", "title", "url", "year"]
