...
*DailyApi* | [**get_daily_word**](docs/DailyApi.md#get_daily_word) | **GET** /daily/word | 每日单词
*DictionaryApi* | [**get_dictionary_audio**](docs/DictionaryApi.md#get_dictionary_audio) | **GET** /dictionary/audio | 单词发音
*DictionaryApi* | [**get_dictionary_lookup**](docs/DictionaryApi.md#get_dictionary_lookup) | **GET** /dictionary/lookup | 单词查询
...
*GameApi* | [**get_game_minecraft_mods**](docs/GameApi.md#get_game_minecraft_mods) | **GET** /game/minecraft/mods | 搜索 MC Mod/插件
...
*GameApi* | [**get_game_minecraft_version**](docs/GameApi.md#get_game_minecraft_version) | **GET** /game/minecraft/version | Minecraft 最新版本
*GameApi* | [**get_game_steam_servers**](docs/GameApi.md#get_game_steam_servers) | **GET** /game/steam/servers | 查询 Steam 游戏服务器
...
*MiscApi* | [**get_misc_movie_box_office**](docs/MiscApi.md#get_misc_movie_box_office) | **GET** /misc/movie-box-office | 查询电影票房
*MiscApi* | [**get_misc_movie_rating_rank**](docs/MiscApi.md#get_misc_movie_rating_rank) | **GET** /misc/movie-rating-rank | 电影收视排行查询
...
*MiscApi* | [**get_misc_weather_history**](docs/MiscApi.md#get_misc_weather_history) | **GET** /misc/weather/history | 查询历史天气
...
*PoemApi* | [**get_saying_random**](docs/PoemApi.md#get_saying_random) | **GET** /saying/random | 一言（随机/每日/场景/此刻）
...
*AIGCApi* | [**post_watermark_decode**](docs/AIGCApi.md#post_watermark_decode) | **POST** /watermark/decode | 提取图片隐水印
*AIGCApi* | [**post_watermark_embed**](docs/AIGCApi.md#post_watermark_embed) | **POST** /watermark/embed | 添加图片隐水印
*AIGCApi* | [**post_watermark_label**](docs/AIGCApi.md#post_watermark_label) | **POST** /watermark/label | 添加 AI 生成内容标识
*AIGCApi* | [**post_watermark_producer_code**](docs/AIGCApi.md#post_watermark_producer_code) | **POST** /watermark/producer-code | 生成 AIGC 服务提供者编码
