...
class GetWebparseMetadata200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["author", "canonical_url", "description", "favicon_url", "generator", "keywords", "language", "open_graph", "page_url", "published_time", "title"]
