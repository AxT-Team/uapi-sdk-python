...
class GetDictionaryLookup200Response(BaseModel):
    """
    GetDictionaryLookup200Response
    """ # noqa: E501
    entry: Optional[GetDictionaryLookup200ResponseEntry] = None
    found: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["entry", "found"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entry": GetDictionaryLookup200ResponseEntry.from_dict(obj["entry"]) if obj.get("entry") is not None else None,
            "found": obj.get("found")
        })
        return _obj
