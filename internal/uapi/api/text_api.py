...
class TextApi:
    ...
    @validate_call
    def post_text_markdown_to_html(
        self,
        post_text_markdown_to_html_request: Annotated[PostTextMarkdownToHtmlRequest, Field(description="请求体使用 `application/json`。`text` 必填；`format` 和 `sanitize` 可选。")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param post_text_markdown_to_html_request: 请求体使用 `application/json`。`text` 必填；`format` 和 `sanitize` 可选。 (required)
        :type post_text_markdown_to_html_request: PostTextMarkdownToHtmlRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_text_markdown_to_html_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PostTextMarkdownToHtml200Response",
            '400': "PostTextMarkdownToHtml400Response",
            '413': "PostTextMarkdownToHtml413Response",
            '500': "PostTextMarkdownToHtml500Response",
            '503': "PostTextMarkdownToHtml503Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def post_text_markdown_to_html_with_http_info(
        self,
        post_text_markdown_to_html_request: Annotated[PostTextMarkdownToHtmlRequest, Field(description="请求体使用 `application/json`。`text` 必填；`format` 和 `sanitize` 可选。")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostTextMarkdownToHtml200Response]:
        """Markdown 转 HTML
    ...
    @validate_call
    def post_text_markdown_to_html_without_preload_content(
        self,
        post_text_markdown_to_html_request: Annotated[PostTextMarkdownToHtmlRequest, Field(description="请求体使用 `application/json`。`text` 必填；`format` 和 `sanitize` 可选。")],
        _request_timeout: Union[
            None,
    ...
    def _post_text_markdown_to_html_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if post_text_markdown_to_html_request is not None:
            _body_params = post_text_markdown_to_html_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/text/markdown-to-html',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_text_markdown_to_pdf(
        self,
        post_text_markdown_to_pdf_request: Annotated[PostTextMarkdownToPdfRequest, Field(description="请求体使用 `application/json`。`text` 必填，`theme` 和 `paper_size` 可选。")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param post_text_markdown_to_pdf_request: 请求体使用 `application/json`。`text` 必填，`theme` 和 `paper_size` 可选。 (required)
        :type post_text_markdown_to_pdf_request: PostTextMarkdownToPdfRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_text_markdown_to_pdf_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "bytearray",
            '400': "PostTextMarkdownToPdf400Response",
            '413': "PostTextMarkdownToPdf413Response",
            '500': "PostTextMarkdownToPdf500Response",
            '502': "PostTextMarkdownToPdf502Response",
            '503': "PostTextMarkdownToPdf503Response",
            '504': "PostTextMarkdownToPdf504Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def post_text_markdown_to_pdf_with_http_info(
        self,
        post_text_markdown_to_pdf_request: Annotated[PostTextMarkdownToPdfRequest, Field(description="请求体使用 `application/json`。`text` 必填，`theme` 和 `paper_size` 可选。")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_text_markdown_to_pdf_without_preload_content(
        self,
        post_text_markdown_to_pdf_request: Annotated[PostTextMarkdownToPdfRequest, Field(description="请求体使用 `application/json`。`text` 必填，`theme` 和 `paper_size` 可选。")],
        _request_timeout: Union[
            None,
    ...
    def _post_text_markdown_to_pdf_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if post_text_markdown_to_pdf_request is not None:
            _body_params = post_text_markdown_to_pdf_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/text/markdown-to-pdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
