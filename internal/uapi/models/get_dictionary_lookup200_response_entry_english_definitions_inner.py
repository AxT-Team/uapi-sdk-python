...
class GetDictionaryLookup200ResponseEntryEnglishDefinitionsInner(BaseModel):
    """
    ...
    part_of_speech: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["definition", "examples", "part_of_speech"]
