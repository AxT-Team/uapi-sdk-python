...
class GetDailyWord200Response(BaseModel):
    """
    ...
    words: Optional[List[GetDailyWord200ResponseWordsInner]] = None
    __properties: ClassVar[List[str]] = ["category", "count", "lang", "words"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "lang": obj.get("lang"),
            "words": [GetDailyWord200ResponseWordsInner.from_dict(_item) for _item in obj["words"]] if obj.get("words") is not None else None
        })
        return _obj
