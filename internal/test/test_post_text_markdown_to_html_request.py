...
class TestPostTextMarkdownToHtmlRequest(unittest.TestCase):
    """PostTextMarkdownToHtmlRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostTextMarkdownToHtmlRequest:
        """Test PostTextMarkdownToHtmlRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostTextMarkdownToHtmlRequest`
        """
        model = PostTextMarkdownToHtmlRequest()
        if include_optional:
            return PostTextMarkdownToHtmlRequest(
                text = '# 咖啡
...
```',
    ...
    def testPostTextMarkdownToHtmlRequest(self):
        """Test PostTextMarkdownToHtmlRequest"""
