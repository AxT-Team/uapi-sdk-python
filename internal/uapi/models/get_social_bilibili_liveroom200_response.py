...
class GetSocialBilibiliLiveroom200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["area_id", "area_name", "attention", "background", "description", "hot_words", "is_portrait", "keyframe", "live_status", "live_time", "new_pendants", "online", "parent_area_id", "parent_area_name", "room_id", "short_id", "tags", "title", "uid", "user_cover"]
