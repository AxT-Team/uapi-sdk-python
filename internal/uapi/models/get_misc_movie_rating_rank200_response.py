...
class GetMiscMovieRatingRank200Response(BaseModel):
    """
    GetMiscMovieRatingRank200Response
    """ # noqa: E501
    channels: Optional[List[GetMiscMovieRatingRank200ResponseChannelsInner]] = None
    var_date: Optional[StrictStr] = Field(default=None, alias="date")
    period: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["channels", "date", "period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "channels": [GetMiscMovieRatingRank200ResponseChannelsInner.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None,
            "date": obj.get("date"),
