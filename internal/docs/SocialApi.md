...
[**get_github_user**](SocialApi.md#get_github_user) | **GET** /github/user | 查询 GitHub 用户信息
...
with uapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_github_repo: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **repo** | **str**| 目标仓库的标识，格式为 &#x60;owner/repo&#x60;。 | 
...
with uapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = uapi.SocialApi(api_client)
    user = 'torvalds' # str | GitHub 用户名（必需符合 GitHub 命名规范：仅限字母、数字、连字符，最长 39 位）。
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_github_user: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user** | **str**| GitHub 用户名（必需符合 GitHub 命名规范：仅限字母、数字、连字符，最长 39 位）。 | 
...
with uapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = uapi.SocialApi(api_client)
    mid = '483307278' # str | B站用户的mid（用户ID）
    keywords = 'keywords_example' # str | 搜索关键词，可为空 (optional)
    orderby = 'pubdate' # str | 排序方式。`pubdate`=最新发布，`views`=最多播放 (optional)
    ps = '20' # str | 每页条数，默认20 (optional)
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_social_bilibili_archives: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **mid** | **str**| B站用户的mid（用户ID） | 
 **keywords** | **str**| 搜索关键词，可为空 | [optional] 
 **orderby** | **str**| 排序方式。&#x60;pubdate&#x60;&#x3D;最新发布，&#x60;views&#x60;&#x3D;最多播放 | [optional] 
 **ps** | **str**| 每页条数，默认20 | [optional] 
 **pn** | **str**| 页码，默认1 | [optional] 
...
with uapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = uapi.SocialApi(api_client)
    mid = '672328094' # str | 主播的用户ID (`mid`)。与 `room_id` 任选其一。 (optional)
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_social_bilibili_liveroom: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **mid** | **str**| 主播的用户ID (&#x60;mid&#x60;)。与 &#x60;room_id&#x60; 任选其一。 | [optional] 
 **room_id** | **str**| 直播间ID，可以是长号（真实ID）或短号（靓号）。与 &#x60;mid&#x60; 任选其一。 | [optional] 
...
with uapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_social_bilibili_replies: %s\n" % e)
```
...
with uapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_social_bilibili_userinfo: %s\n" % e)
```
...
with uapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = uapi.SocialApi(api_client)
    aid = '75836761' # str | 视频的AV号 (aid)，纯数字格式。`aid`和`bvid`任选其一即可。 (optional)
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_social_bilibili_videoinfo: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **aid** | **str**| 视频的AV号 (aid)，纯数字格式。&#x60;aid&#x60;和&#x60;bvid&#x60;任选其一即可。 | [optional] 
 **bvid** | **str**| 视频的BV号 (bvid)，例如 &#x60;BV117411r7R1&#x60;。&#x60;aid&#x60;和&#x60;bvid&#x60;任选其一即可。 | [optional] 
...
with uapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_social_qq_groupinfo: %s\n" % e)
```
...
with uapi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SocialApi->get_social_qq_userinfo: %s\n" % e)
```
