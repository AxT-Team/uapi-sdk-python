...
**pinned_repositories** | [**List[GetGithubUser200ResponsePinnedRepositoriesInner]**](GetGithubUser200ResponsePinnedRepositoriesInner.md) | 用户主页展示的 pinned 仓库列表（需开启 pinned&#x3D;true）。 | [optional] 
